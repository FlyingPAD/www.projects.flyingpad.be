...
export const slideInAnimation = trigger('routeAnimations', [
  ...
  transition('higherOrLower => diceRoll, higherOrLower => trainer, higherOrLower => virtualPet', slideToLeft),
  transition('diceRoll => trainer, diceRoll => virtualPet', slideToLeft),
  transition('trainer => virtualPet', slideToLeft),
  ...
  transition('virtualPet => trainer, virtualPet => diceRoll, virtualPet => higherOrLower', slideToRight),
